...
const Card: React.FC<CardProps> = ({
	...
	return (
		<div className='card'>
			...
			{cardIndex < catImages.length && species === "Cat" && (
				<CardImage
					image={catImages[cardIndex].image}
					altText={catImages[cardIndex].altText}
					licenceType={catImages[cardIndex].licenceType}
					licenceUrl={catImages[cardIndex].licenceUrl}
					attributionName={catImages[cardIndex].attributionName}
					attributionUrl={catImages[cardIndex].attributionUrl}
				/>
			)}
